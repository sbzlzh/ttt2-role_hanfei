...
L["info_popup_" .. HANFEI.name] = [[You are the Middle Eastern Bandit!
...
L["ttt2_desc_" .. HANFEI.name] = [[This is a powerful traitor!
He starts the game with a C4, high armor, and an AK. Upon death, he triggers an Allahu Akbar sound effect and explodes, causing area damage!]]

L["label_hanfei_armor"] = "Amount of Armor"
L["label_hanfei_hp"] = "Amount of Health Points"
L["label_hanfei_exposetime"] = "Exposure Time"
L["ttt2_hanfei_chat_reveal"] = "{playername} is the Middle Eastern Bandit this round, let's all take him down together!"
L["ttt2_hanfei_chat_exposetime"] = "There was a loud explosion! Middle Eastern Bandit: {playername}"
