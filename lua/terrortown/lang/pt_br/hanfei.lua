...
-- Este personagem não atacou nenhuma pessoa, coisa ou situação; por favor, não interprete isso.
-- Data da atualização: 28 de março de 2023
local L = LANG.GetLanguageTableReference("pt_br")

-- GENERAL ROLE LANGUAGE STRINGS
L[HANFEI.name] = "Bandido do Oriente Médio"
L["info_popup_" .. HANFEI.name] = [[Você é o Bandido do Oriente Médio!
...
L["ttt2_desc_" .. HANFEI.name] = [[Este é um traidor poderoso!
Ele começa o jogo com um C4, alta armadura e um AK. Ao morrer, ele aciona um efeito sonoro de Allahu Akbar e explode, causando dano em área!]]
